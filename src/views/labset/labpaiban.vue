  ...
  <div>
    ...
    <el-card>
      <div>
        <el-form :inline="true">
          <el-form-item>
              <router-link :to="{path:'/hospSet/updatepaiban/',query:{lab:this.searchObj.lab,chosen:this.chosen} }">
              <!--<router-link to="{path:'/hospSet/updatepaiban/',query:{lab:this.searchObj.lab,choose:this.choose}}"> -->
           <el-button type="primary" size="small">编辑排班</el-button>
            ...
            <!-- <a :href="'http://localhost:8201/admin/lab/down?DateList='+DateList+'&labid='+this.searchObj.lab" target="_blank" method="post"> -->
             <a :href="'http://xmr.coyotebio-lab.com:8201/admin/lab/down?DateList='+DateList+'&labid='+this.searchObj.lab" target="_blank" method="post">
                ...
                <el-button type="primary" size="small" @click="importData"><i class="fa fa-plus"/> 导入</el-button>
                 <a href='static/shiyanshipaiban.xlsx'><font style='color:blue;'>排班导入模板 </font></a>
                 <!-- <el-button type="primary" size="small" @click="importData"><i class="fa fa-plus"/> 导入</el-button> -->
          </el-form-item>
        </el-form>
      </div>
...
export default {
  ...
  created() {
    ...
    if (this.$route.query && this.$route.query.id) {
      this.searchObj.lab = this.$route.query.id;
    } 
    var m=getRole().split(",")
    console.log(m[0]);
    ...
    this.getChannel();
    if(!this.roleId){
             this.searchObj.lab=this.labList[0].id;
          }
    this.getlist();
  },
  resetForm(formName) {
  ...
  methods: {
    //点击编辑按钮并传值labid和choose
    // jump(){
    //   this.$router.push({
    //     path:"/hospSet/updatepaiban/",
    //     query:{labid:this.searchObj.lab,
    //            choose:this.choose}
    //   })
    ...
    uploadUrl: function() {
      return (
        "http://xmr.coyotebio-lab.com:8201/admin/lab/importSch"
